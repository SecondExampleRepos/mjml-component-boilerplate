    ...
    <body style={{ wordSpacing: 'normal' }}>
      <Container style={{ margin: '0px auto', maxWidth: '600px' }}>
        <Section style={{ width: '100%' }}>
          <Column style={{ width: '100%', textAlign: 'left', display: 'inline-block', verticalAlign: 'top' }}>
            <Section style={{ textAlign: 'center', padding: '20px 0' }}>
              <Column style={{ width: '100%', textAlign: 'left', display: 'inline-block', verticalAlign: 'top' }}>
                <Section style={{ padding: '10px 25px', wordBreak: 'break-word' }}>
                  <Column style={{ display: 'inline-table', float: 'none' }}>
                    <Section style={{ padding: '4px', verticalAlign: 'middle' }}>
                      <Column style={{ background: '#3b5998', borderRadius: '3px', width: '30px' }}>
                  ...
                  <Column style={{ display: 'inline-table', float: 'none' }}>
                    <Section style={{ padding: '4px', verticalAlign: 'middle' }}>
                      <Column style={{ background: '#dc4e41', borderRadius: '3px', width: '30px' }}>
                  ...
                  <Column style={{ display: 'inline-table', float: 'none' }}>
                    <Section style={{ padding: '4px', verticalAlign: 'middle' }}>
                      <Column style={{ background: '#55acee', borderRadius: '3px', width: '30px' }}>
