...
import { Button, Column, Container, Font, Head, Heading, Hr, Html, Image, Link, Preview, Section, Text } from '@react-email/components';
      ...
      <Container style={{ margin: '0px auto', maxWidth: '600px' }}>
        <Section style={{ direction: 'ltr', fontSize: '0px', padding: '20px 0', textAlign: 'center' }}>
          <Column style={{ fontSize: '0px', textAlign: 'left', direction: 'ltr', display: 'inline-block', verticalAlign: 'top', width: '100%' }}>
            <Section style={{ verticalAlign: 'top', width: '100%' }}>
              <Column align="center" style={{ fontSize: '0px', padding: '10px 25px', wordBreak: 'break-word' }}>
                <Section align="center" style={{ float: 'none', display: 'inline-table' }}>
                  <Column style={{ padding: '4px', verticalAlign: 'middle' }}>
                    <Section style={{ background: '#3b5998', borderRadius: '3px', width: '30px' }}>
                      <Column style={{ fontSize: '0', height: '30px', verticalAlign: 'middle', width: '30px' }}>
