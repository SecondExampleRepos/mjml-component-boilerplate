...
import { Html, Head, Font, Container, Section, Column, Link, Text } from '@react-email/components';
        ...
        <Container style={{ backgroundColor: '#ef6451', margin: '0 auto', maxWidth: '600px' }}>
          <Section>
            <Column style={{ width: '100%' }}>
              <input type="checkbox" id="d352074d8fe4cd0e" className="mj-menu-checkbox" style={{ display: 'none !important', maxHeight: '0', visibility: 'hidden' }} />
              <div className="mj-menu-trigger" style={{ display: 'none', maxHeight: '0px', maxWidth: '0px', fontSize: '0px', overflow: 'hidden' }}>
                <label htmlFor="d352074d8fe4cd0e" className="mj-menu-label" style={{ display: 'block', cursor: 'pointer', color: '#ffffff', fontSize: '30px', fontFamily: 'Ubuntu, Helvetica, Arial, sans-serif', textTransform: 'uppercase', textDecoration: 'none', lineHeight: '30px', padding: '10px' }} align="center">
