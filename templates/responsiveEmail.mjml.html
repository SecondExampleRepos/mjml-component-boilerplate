      ...
      <Container style={{ margin: '0px auto', maxWidth: '600px' }}>
        <Section style={{ padding: '20px 0', textAlign: 'center' }}>
          <Column style={{ width: '50%', display: 'inline-block', verticalAlign: 'top' }}>
            <Image src="https://mjml.io/assets/img/easy-and-quick.png" alt="" width="137" height="185" style={{ display: 'block', width: '100%', height: '185px' }} />
          ...
          <Column style={{ width: '50%', display: 'inline-block', verticalAlign: 'top' }}>
            <Image src="https://mjml.io/assets/img/responsive.png" alt="" width="166" height="185" style={{ display: 'block', width: '100%', height: '185px' }} />
            <Text style={{ fontFamily: 'Ubuntu, Helvetica, Arial, sans-serif', fontSize: '13px', lineHeight: '1', textAlign: 'center', color: '#000000' }}>
