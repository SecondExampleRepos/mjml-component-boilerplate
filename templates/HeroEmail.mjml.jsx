      ...
      <Container>
        <Section style={{ background: '#2a3448 url(https://cloud.githubusercontent.com/assets/1830348/15354890/1442159a-1cf0-11e6-92b1-b861dadf1750.jpg) no-repeat center center / cover', padding: '100px 0', height: '269px' }}>
          <Column>
            ...
            <Button href="https://mjml.io/" style={{ background: '#414141', color: '#ffffff', fontFamily: 'Ubuntu, Helvetica, Arial, sans-serif', fontSize: '13px', fontWeight: 'normal', lineHeight: '120%', textDecoration: 'none', padding: '10px 25px', borderRadius: '3px' }}>
