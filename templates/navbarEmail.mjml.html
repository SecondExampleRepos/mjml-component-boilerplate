      ...
      <Container style={{ backgroundColor: '#ef6451', margin: '0 auto', maxWidth: '600px' }}>
        <Section style={{ backgroundColor: '#ef6451', width: '100%' }}>
          <Column style={{ width: '100%' }}>
            <input type="checkbox" id="fb33d08f1431f7be" className="mj-menu-checkbox" style={{ display: 'none !important', maxHeight: '0', visibility: 'hidden' }} />
            <div className="mj-menu-trigger" style={{ display: 'none', maxHeight: '0px', maxWidth: '0px', fontSize: '0px', overflow: 'hidden' }}>
              <label htmlFor="fb33d08f1431f7be" className="mj-menu-label" style={{ display: 'block', cursor: 'pointer', color: '#ffffff', fontSize: '30px', fontFamily: 'Ubuntu, Helvetica, Arial, sans-serif', textTransform: 'uppercase', textDecoration: 'none', lineHeight: '30px', padding: '10px' }} align="center">
