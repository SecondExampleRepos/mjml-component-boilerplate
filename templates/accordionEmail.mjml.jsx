...
const AccordionEmail = () => (
  <Html>
    ...
    <body style={{ wordSpacing: 'normal' }}>
      <Container style={{ backgroundColor: '#ffffff', margin: '0px auto', maxWidth: '600px' }}>
                  ...
                  <div className="mj-accordion-element" style={{ fontSize: '13px' }}>
                    ...
                    <div>
                      <div className="mj-accordion-title">
                        <Section style={{ width: '100%', borderBottom: 'none' }}>
                          <Column style={{ width: '100%', backgroundColor: '#ffffff', color: '#031017', fontSize: '18px', fontFamily: 'Roboto, Open Sans, Helvetica, Arial, sans-serif', padding: '15px' }}>
                            Why use an accordion?
                          </Column>
                          <Column className="mj-accordion-ico" style={{ padding: '16px', background: '#ffffff', verticalAlign: 'middle' }}>
                      ...
                      <div className="mj-accordion-content">
                        <Section style={{ width: '100%', borderBottom: 'none' }}>
                          <Column style={{ background: '#fafafa', fontSize: '14px', fontFamily: 'Open Sans, Helvetica, Arial, sans-serif', lineHeight: '1', color: '#505050', padding: '15px' }}>
                            <span style={{ lineHeight: '20px' }}> Because emails with a lot of content are most of the time a very bad experience on mobile, mj-accordion comes handy when you want to deliver a lot of information in a concise way. </span>
                          </Column>
                        </Section>
                      </div>
                    </div>
                  ...
                  <div className="mj-accordion-element" style={{ fontSize: '13px' }}>
                    ...
                    <div>
                      ...
                      <div className="mj-accordion-content">
                        <Section style={{ width: '100%', borderBottom: 'none' }}>
                          <Column style={{ background: '#fafafa', fontSize: '14px', fontFamily: 'Open Sans, Helvetica, Arial, sans-serif', lineHeight: '1', color: '#505050', padding: '15px' }}>
                            <span style={{ lineHeight: '20px' }}> Content is stacked into tabs and users can expand them at will. If responsive styles are not supported (mostly on desktop clients), tabs are then expanded and your content is readable at once. </span>
                          </Column>
                        </Section>
                      </div>
                    </div>
