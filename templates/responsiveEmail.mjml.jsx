...
const ResponsiveEmail = () => (
  <Html>
    ...
    <Preview>Responsive Email</Preview>
    <Tailwind>
      <Container style={{ margin: '0 auto', maxWidth: '600px' }}>
        <Section style={{ padding: '20px 0', textAlign: 'center' }}>
          <Column style={{ width: '50%', display: 'inline-block', verticalAlign: 'top' }}>
            ...
            <Text>Write less code, save time and code more efficiently with MJML’s semantic syntax.</Text>
          </Column>
          <Column style={{ width: '50%', display: 'inline-block', verticalAlign: 'top' }}>
            ...
            <Text>MJML is responsive by design on most-popular email clients, even Outlook.</Text>
          </Column>
        </Section>
      </Container>
    </Tailwind>
